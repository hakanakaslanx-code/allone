...
translations = {
    "en": {
        ...
        "ABOUT_CONTENT": (
            ...
            "--- WHAT'S INSIDE ---\n"
            "File & Image Tools:\n"
            "  • Copy or move images by SKU list from Excel/CSV/TXT between source and target folders.\n"
            "  • Convert HEIC/WEBP batches to JPG.\n"
            "  • Batch resize and compress images by width or percentage.\n"
            "  • Match external image link CSV files to Excel/CSV sheets and add URL columns.\n"
            "View in Room:\n"
            "  • Place rugs on room photos, drag/scale/rotate them, adjust perspective, and export previews.\n"
            "Utility:\n"
            "  • ID Column Formatter and Scanner Comma Joiner for quick SKU cleanup.\n"
            "  • Quick Dimension Calculator and Bulk Dimension Processor for spreadsheet columns.\n"
            "  • Unit Converter with synchronized cm/in/ft inputs.\n"
            "Column Match & Report:\n"
            "  • Compare primary vs. reference lists to flag rug numbers that are missing.\n"
            "Code Generators:\n"
            "  • Create QR codes and barcodes as PNGs or Dymo labels with optional bottom text.\n"
            "Rinven Tools:\n"
    ...
    "tr": {
        ...
        "ABOUT_CONTENT": (
            "AllOne Tools - v{version}\n"
            "Dosya, görsel, veri ve etiketleme işlerini tek masaüstü alanında toplar.\n"
            "--- İÇERİK ---\n"
            ...
            "Araçlar:\n"
            "  • Hızlı SKU düzeni için ID Sütun Biçimlendirici ve Tarayıcı Virgül Birleştirici.\n"
            "  • Tekil Ölçü Hesaplayıcı ve Toplu Ölçü İşleyici ile tablo sütunlarını hesapla.\n"
            "  • Eşzamanlı cm/in/ft girişleri olan Birim Dönüştürücü.\n"
            "Sütun Eşleştir & Raporla:\n"
            "  • Birincil ve referans listeleri karşılaştırıp eksik halı numaralarını işaretler.\n"
            "Kod Üreteçleri:\n"
            "  • Alt metinli PNG veya Dymo etiketleri olarak QR kodu ve barkod üret.\n"
            "Rinven Araçları:\n"
